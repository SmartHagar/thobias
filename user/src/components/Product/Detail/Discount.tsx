              ...
              <div className="list-action mt-6">
                  ...
                  <div className="flex items-center gap-3 mt-3">
                    <div className="item relative">
                      ...
                      <div className="content absolute top-1/2 -translate-y-1/2 md:right-1 right-2 flex items-center gap-2">
                        ...
                        <div className="button bg-white font-semibold text-xs py-1 px-2 rounded-full duration-300 hover:bg-black hover:text-white cursor-pointer">
                          Apply
                        </div>
                      </div>
                    </div>
                ...
                <div className="list-payment mt-7">
                  <div className="main-content lg:pt-8 pt-6 lg:pb-6 pb-4 sm:px-4 px-3 border border-line rounded-xl relative max-md:w-2/3 max-sm:w-full">
                    <div className="heading6 px-5 bg-linear absolute -top-[14px] left-1/2 -translate-x-1/2 whitespace-nowrap">
