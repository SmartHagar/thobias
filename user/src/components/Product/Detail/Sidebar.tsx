            ...
            <div className="right lg:w-3/4 sm:w-[60%] sm:pl-3 w-full">
              ...
              <div className="desc-tab mt-[60px]">
                ...
                <div className="desc-block mt-8">
                    ...
                    <div className="grid lg:grid-cols-2 gap-8 gap-y-5">
                      <div className="left">
                        ...
                        <div className="text-secondary mt-2">
                          ...
                          only make a great storage units, but also bring a
                          great decorative accent to your decor. Traditionally
                          designed, they are perfect to be used in the hallway,
                          living room, bedroom, office or any place where you
                          need to store or display things. Made of high quality
                          materials, they are sturdy and durable for years.
                          Bring one-of-a-kind look to your interior with
                      ...
                      <div className="right">
                        ...
                        <div className="list-feature">
                          ...
                          <div className="item flex gap-1 text-secondary mt-1">
                            <Icon.Dot size={28} />
                            <p>
                              Nulla luctus libero quis mauris vestibulum
                              dapibus.
                            </p>
                          </div>
                          <div className="item flex gap-1 text-secondary mt-1">
                          ...
                          <div className="item flex gap-1 text-secondary mt-1">
                            <Icon.Dot size={28} />
                            <p>
                              Mauris in nisl scelerisque massa consectetur
                              pretium sed et mauris.
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div
                    className={`desc-item specifications flex items-center ${
        ...
        <div className="related-product md:pb-20 pb-10">
          <div className="container">
            ...
            <div className="list-product hide-product-sold  grid lg:grid-cols-4 grid-cols-2 md:gap-[30px] gap-5 md:mt-10 mt-6">
              {data.slice(Number(productId), Number(productId) + 4).length <
              4 ? (
                <>
