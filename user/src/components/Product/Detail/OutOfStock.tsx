              ...
              <div className="list-action mt-6">
                ...
                <div className="choose-size mt-5">
                  <div className="heading flex items-center justify-between">
                    <div className="text-title">
                      Size:{" "}
                      <span className="text-title size">Out of stock</span>
                    </div>
                    <div
                ...
                <div className="choose-quantity flex items-center lg:justify-between gap-5 gap-y-3 mt-3">
                  <div className="quantity-block md:p-3 max-md:py-1.5 max-md:px-3 flex items-center justify-between rounded-lg border border-line sm:w-[180px] w-[120px] flex-shrink-0">
                    <Icon.Minus size={20} className="disabled" />
                    <div className="body1 font-semibold">
                      {productMain.quantityPurchase}
                    </div>
                    <Icon.Plus size={20} className="disabled" />
                  </div>
                  <div className="button-main w-full text-center bg-surface text-secondary2 border border-line">
                    Out Of Stock
                  </div>
                </div>
